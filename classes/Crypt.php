...
class Crypt {
   ...
   /**
	...
	public function decryptArrayKeys($array) {
        if (is_array($array)){
        	$arrayResult=array();
        	foreach ($array as $name=>$value){
        		$arrayResult[$this->decrypt($name)]=$value;
        	}
        }else{
	...
	public function encryptArrayKeys($array) {
        if (is_array($array)){
        	$arrayResult=array();
        	foreach ($array as $name=>$value){
        		$arrayResult[$this->encrypt($name)]=$value;
        	}
        }else{
	...
	public function decryptArrayValues($array) {
        if (is_array($array)){
        	$arrayResult=array();
        	foreach ($array as $name=>$value){
        		$arrayResult[$name]=$this->decrypt($value);
        	}
        }else{
        	return $this->decrypt($array);
        }
	...
	public function encryptArrayValues($array) {
        if (is_array($array)){
        	$arrayResult=array();
        	foreach ($array as $name=>$value){
        		$arrayResult[$name]=$this->encrypt($value);
        	}
        }else{
        	return $this->encrypt($array);
        }
