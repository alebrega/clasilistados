...
static function singleton(){
    ...
    // global $servers
    global $servers_memcache;
    
    self::$instance || 
        self::$instance = new Cache($servers_memcache);
...
protected function __construct(array $servers){
    ...
    if (!$this->mc_servers_count){
        $this->mc_servers[0]=new CacheDesconectado();
    }
}
/**
